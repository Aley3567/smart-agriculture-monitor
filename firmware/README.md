...
| 水泵/LED1 | P1.0 | 继电器或 LED |
| 施肥/LED2 | P1.1 | 继电器或 LED |
| 天窗/LED3 | P1.6 | 继电器或 LED |
| OLED SDA | 按驱动定义 | OLED 模块 |
| OLED SCL | 按驱动定义 | OLED 模块 |
...
| 命令 | 功能 |
|------|------|
| `BLEGLED1` | 开启水泵 (P1.0 = 1) |
| `BLEKLED1` | 关闭水泵 (P1.0 = 0) |
| `BLEGLED2` | 开启施肥 (P1.1 = 1) |
| `BLEKLED2` | 关闭施肥 (P1.1 = 0) |
| `BLEGLED3` | 开启天窗 (P1.6 = 1) |
| `BLEKLED3` | 关闭天窗 (P1.6 = 0) |
